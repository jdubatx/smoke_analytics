...
class AverageResponseTimeByUnit < Test::Unit::TestCase
  ...
  def test_average_response_time_by_unit
    ...
    @driver.find_element(:xpath, "//div[2]/div[5]/div[2]").click
     assert !60.times{ break if (@driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[9]/div[2]/table/tbody/tr/td/div").text == "Average Response Time By Unit" rescue false); sleep 1 }
    @driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[9]/div[2]/table/tbody/tr/td/div").click
	sleep (2)
	#Report Nav Done
