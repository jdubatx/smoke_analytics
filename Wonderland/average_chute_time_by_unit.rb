...
class AverageChuteTimeByUnit < Test::Unit::TestCase
  ...
  def test_average_chute_time_by_unit
    ...
    @driver.find_element(:xpath, "//div[2]/div[5]/div[2]").click
     assert !60.times{ break if (@driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[6]/div[2]/table/tbody/tr/td/div").text == "Average Chute Time By Unit" rescue false); sleep 1 }
    @driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[6]/div[2]/table/tbody/tr/td/div").click
	sleep (2)
	#Report Nav Done
  ...
  #Select Current Year Start
   ...
   sleep (2)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[2]/td[2]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   sleep (2)
   ...
   sleep (1)
    @driver.find_element(:xpath, "//ul[@id='filters-combo-2-1_listbox']/li[16]").click
	sleep (1)
   ...
   @driver.find_element(:css, "span.k-input").click 
   sleep (1)
    @driver.find_element(:xpath, "//ul[@id='filters-combo-3-1_listbox']/li[22]").click
	sleep (1)
	@driver.find_element(:xpath, "//div[2]/span/span/span").click
   sleep (1)
   @driver.find_element(:xpath, "//div[7]/div/ul/li[2]").click
  ...
  @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr/td[2]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   sleep (2)
  @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[2]/td[2]").click
   ...
   @driver.find_element(:css, "div.back").click
   sleep (2)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[3]/td[2]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
