...
class AverageResponseTime < Test::Unit::TestCase
  ...
  def test_response_time
    ...
    assert !60.times{ break if (@driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[7]/div[2]/table/tbody/tr/td/div").text == "Average Response Time" rescue false); sleep 1 }
    @driver.find_element(:xpath, "//div[7]/div[2]/table/tbody/tr/td/div").click
	sleep (4)
	#Report Nav Done
   ...
   @driver.find_element(:css, "div.back").click
   sleep (6)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[14]/td[15]").click
   @driver.find_element(:css, "div.back").click
   sleep (6)
...
#Add Filters Start    
   ...
   sleep (4)
    @driver.find_element(:xpath, "//ul[@id='filters-combo-2-1_listbox']/li[4]").click
	sleep (4)
   ...
   sleep (4)
   @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-1_listbox']/li[2]").click
   sleep (4)
   @driver.find_element(:xpath, "//div[4]/div/div/input").click
   sleep (4)
   @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-1_listbox']/li[3]").click
   sleep (4)
   @driver.find_element(:xpath, "//div[4]/div/div/input").click
   sleep (4)
   ...
   @driver.find_element(:css, "div.back").click
   sleep (4)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr/td[15]").click
   sleep (4)
   @driver.find_element(:css, "div.back").click
   sleep (4)
