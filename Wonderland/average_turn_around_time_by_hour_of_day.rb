...
class AverageTurnAroundTimeByHourOfDay < Test::Unit::TestCase
    ...
    assert_equal [], @verification_errors
        ...
        def test_average_turn_around_time_by_hour_of_day
    ...
    @driver.find_element(:xpath, "//div[2]/div[5]/div[2]").click
     assert !60.times{ break if (@driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[12]/div[2]/table/tbody/tr/td/div").text == "Average Turn Around Time By Hour of Day" rescue false); sleep 1 }
    @driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[12]/div[2]/table/tbody/tr/td/div").click
	sleep (2)
	#Report Nav Done
	...
	#PDF View Start
    @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr/td/div/a").click
