...
class AverageChuteTimeByHourOfDay < Test::Unit::TestCase
  ...
  def test_average_chute_time_by_hour_of_day
    ...
    @driver.find_element(:xpath, "//div[2]/div[5]/div[2]").click
      assert !60.times{ break if (@driver.find_element(:xpath, "//div[5]/div[2]/table/tbody/tr/td/div").text == "Average Chute Time By Hour of Day" rescue false); sleep 1 }
    @driver.find_element(:xpath, "//div[5]/div[2]/table/tbody/tr/td/div").click
	sleep (2)
	#Report Nav Done
  ...
  @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr/td[5]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   sleep (2)
  @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[4]/td[2]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   sleep (2)
   ...
   sleep (1)
    @driver.find_element(:xpath, "//ul[@id='filters-combo-2-1_listbox']/li[9]").click
	sleep (1)
   ...
   sleep (1)
    @driver.find_element(:xpath, "//div[4]/div/div/input").click
   sleep (1)
   @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-1_listbox']/li[5]").click
   sleep (1)
    @driver.find_element(:xpath, "//div[4]/div/div/input").click
   sleep (1)
   @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-1_listbox']/li[6]").click
   sleep (1)
    @driver.find_element(:xpath, "//div[4]/div/div/input").click
   sleep (1)
   @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-1_listbox']/li[7]").click
   sleep (1)
   ...
   @driver.find_element(:css, "span.k-input").click 
   sleep (1)
    @driver.find_element(:xpath, "//ul[@id='filters-combo-3-1_listbox']/li[36]").click
	sleep (1)
	@driver.find_element(:xpath, "//div[2]/span/span/span").click
   sleep (1)
   @driver.find_element(:xpath, "//div[7]/div/ul/li[2]").click
   ...
   sleep (2)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[3]/td[4]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   sleep (2)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[4]/td[4]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   sleep (2)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[3]/td[9]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   ...
   sleep (2)
	...
	sleep (1)
    @driver.find_element(:xpath, "//div[4]/div/div[2]/div[2]/input").send_keys "  -ruby_actbhod"
    @driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "  -ruby_actbhod"
    @driver.find_element(:xpath, "//div[6]/div/div/div[5]/div[2]").click
	sleep (1)
    @driver.find_element(:css, "button.button-gray.float-left").click
	sleep (1)
    @driver.find_element(:xpath, "//div[6]/div/div[2]/div/input").send_keys "  -ruby_actbhod"
