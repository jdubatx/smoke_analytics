...
class AverageSceneTimeForStrokePatients < Test::Unit::TestCase
  ...
  def test_average_scene_time_for_stroke_patients
    ...
    assert !60.times{ break if (@driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div[2]/div[4]/div[2]").text == "Clinical Reports" rescue false); sleep 1 }
    @driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div[2]/div[4]/div[2]").click
    assert !60.times{ break if (@driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[4]/div[2]/table/tbody/tr/td/div").text == "Average Scene Time For Stroke Patients" rescue false); sleep 1 }
    @driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[4]/div[2]/table/tbody/tr/td/div").click
	sleep (2)
	#Report Nav Done
