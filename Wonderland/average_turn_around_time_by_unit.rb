...
class AverageTurnAroundTimeByUnit < Test::Unit::TestCase
  ...
  def test_average_turn_around_time_by_unit
    ...
    @driver.find_element(:xpath, "//div[2]/div[5]/div[2]").click
     assert !60.times{ break if (@driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[13]/div[2]/table/tbody/tr/td/div").text == "Average Turn Around Time By Unit" rescue false); sleep 1 }
    @driver.find_element(:xpath, "//div[@id='app-root']/div/div[5]/div/div/div/div[13]/div[2]/table/tbody/tr/td/div").click
	sleep (2)
	#Report Nav Done
 ...
 #Select Current Year Start
   ...
   sleep (2)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[9]/td[2]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   sleep (2)
    ...
    sleep (1)
	#Patient age greater than 40
    @driver.find_element(:xpath, "//ul[@id='filters-combo-2-1_listbox']/li[20]").click
    ...
    sleep (1)
    @driver.find_element(:xpath, "//div[3]/input").send_keys "40"
	@driver.find_element(:xpath, "//div[3]/div/div/div/div/div").click
	#OR Secondary Impression equals carc shock  alte cpnc cpd ra
    @driver.find_element(:xpath, "//table[2]/tbody/tr/td/div/div/div/span/span/span[2]/span").click
    @driver.find_element(:xpath, "//ul[@id='filters-combo-2-2_listbox']/li[32]").click
    ...
    @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-2_listbox']/li[3]").click
    @driver.find_element(:xpath, "//table[2]/tbody/tr/td/div/div/div[4]/div/div").click	
    @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-2_listbox']/li[2]").click
    @driver.find_element(:xpath, "//table[2]/tbody/tr/td/div/div/div[4]/div/div").click	
    @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-2_listbox']/li[4]").click
    @driver.find_element(:xpath, "//table[2]/tbody/tr/td/div/div/div[4]/div/div").click	
    @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-2_listbox']/li[5]").click
    @driver.find_element(:xpath, "//table[2]/tbody/tr/td/div/div/div[4]/div/div").click	
    @driver.find_element(:xpath, "//ul[@id='multiselect-combo-2-2_listbox']/li[9]").click
   ...
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[2]/td[10]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   sleep (2)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr/td[10]").click
   ...
   @driver.find_element(:css, "div.back").click
   sleep (2)
   @driver.find_element(:xpath, "//div[@id='content']/div[2]/table/tbody/tr[16]/td[3]").click
   sleep (2)
   @driver.find_element(:css, "div.back").click
   ...
   sleep (1)
   @driver.find_element(:link, "Open PDF").click
   sleep (2)
   ...
   sleep (2)
	...
	sleep (1)
    @driver.find_element(:xpath, "//div[4]/div/div[2]/div[2]/input").send_keys "  -ruby_atat"
    @driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "  -ruby_atat"
    @driver.find_element(:xpath, "//div[6]/div/div/div[5]/div[2]").click
	sleep (1)
    @driver.find_element(:css, "button.button-gray.float-left").click
	sleep (1)
    @driver.find_element(:xpath, "//div[6]/div/div[2]/div/input").send_keys "  -ruby_atat"
