...
class AverageTurnAroundTime < Test::Unit::TestCase
  ...
  def test_average_turn_around_time
    ...
    assert !60.times{ break if (@driver.find_element(:xpath, "//div[11]/div[2]/table/tbody/tr/td/div").text == "Average Turn Around Time" rescue false); sleep 1 }
    @driver.find_element(:xpath, "//div[11]/div[2]/table/tbody/tr/td/div").click
	sleep (2)
	#Report Nav Done
